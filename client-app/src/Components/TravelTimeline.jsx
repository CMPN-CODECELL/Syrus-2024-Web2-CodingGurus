...
<div className="max-w-7xl mx-auto w-full grid grid-cols-9 px-2 py-12">
       
        <div className="col-span-4 w-full h-full ">
            <div className="w-full h-full bg-indigo-400 rounded-md p-2 md:pl-4">
                <h1 className="text-white text-xl font-medium py-2">Maharastra</h1>
        ...
        <div className="relative col-span-1 w-full h-full flex justify-center items-center">
            ...
            <div className="absolute w-6 h-6 rounded-full bg-indigo-400 z-10 text-white text-center hover:bg-blue-600">1</div>
        </div>
        ...
        <div className="relative col-span-1 w-full h-full flex justify-center items-center">
            <div className="h-full w-1 bg-indigo-300"></div>
            <div className="absolute w-6 h-6 rounded-full bg-indigo-400 z-10 text-white text-center hover:bg-blue-600">2</div>
        </div>
        <div className="col-span-4 w-full h-full ">
            <div className="w-full h-full bg-indigo-400 rounded-md p-2 md:pl-4">
                <h1 className="text-white text-xl font-medium py-2">Maharastra</h1>
        ...
        <div className="relative col-span-1 w-full h-full flex justify-center items-center">
            <div className="h-full w-1 bg-indigo-300"></div>
            <div className="absolute w-6 h-6 rounded-full bg-indigo-400 z-10 text-white text-center hover:bg-blue-600">3</div>
        </div>
        <div className="col-span-4 w-full h-full"></div>
    </div>
    </div>
